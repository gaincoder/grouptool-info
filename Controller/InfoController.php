...
class InfoController
{
    ...
    public function indexAction()
    {
        ...
        return new Response($this->twig->render('@Info/index.html.twig', ['infos' => $infos]));
    }
    ...
    public function create(Request $request)
    {
        ...
        return new Response($this->twig->render('@Info/form.html.twig', ['form' => $form->createView(), 'page_title' => 'Info hinzufügen']));
    }
    ...
    public function edit(Info $info, Request $request)
    {
        ...
        return new Response($this->twig->render('@Info/form.html.twig', ['form' => $form->createView(), 'page_title' => 'Info bearbeiten']));
    }
    ...
    {
        if ($confirm == false) {
            return new Response($this->twig->render('confirm.html.twig', ['type' => 'Info']));
        }
